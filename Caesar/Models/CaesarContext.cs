...
using Caesar.Models.Mapping;

namespace Caesar.Models
{
    public partial class CaesarContext : DbContext
    {
        static CaesarContext()
        {
            Database.SetInitializer<CaesarContext>(null);
        }

        public CaesarContext()
            : base("Name=CaesarContext")
        {
        }
